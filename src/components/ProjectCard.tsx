...
export const ProjectCard = ({ project, onSelect, index }: ProjectCardProps) => {
  ...
  return (
    ...
    >
      <motion.div
        className="rounded-xl overflow-hidden h-[432px] flex flex-col transition-all duration-300 shadow-lg hover:shadow-[0_0_25px_rgba(255,0,255,0.8)] border border-gray-700 bg-gradient-to-br from-purple-900/20 to-blue-900/20 hover:from-purple-900/30 hover:to-blue-900/30"
