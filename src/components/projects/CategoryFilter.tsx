...
export const CategoryFilter = ({ categories, activeCategory, onSelectCategory }: CategoryFilterProps) => {
  const getCategoryStyles = (category: string, isActive: boolean) => {
    ...
    switch (category) {
      case "VRChat Worlds":
        return "bg-pink-500/70 text-pink-100 border-pink-500";
      case "Free Tools":
        return "bg-blue-500/70 text-blue-100 border-blue-500";
      case "Content Creation":
        return "bg-green-500/70 text-green-100 border-green-500";
      case "Community":
        return "bg-yellow-500/70 text-yellow-100 border-yellow-500";
      case "All":
        return "bg-purple-500/70 text-purple-100 border-purple-500";
      default:
        return "bg-purple-500/70 text-purple-100 border-purple-500";
    }
  };
